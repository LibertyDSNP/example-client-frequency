...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    messages: {
       ...
       * # </weight>
       **/
      add: AugmentedSubmittable<(onBehalfOf: Option<u64> | null | object | string | Uint8Array, schemaId: u16 | AnyNumber | Uint8Array, message: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<u64>, u16, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    schemas: {
      registerSchema: AugmentedSubmittable<(schema: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes]>;
      /**
       * Set a new value for the Schema maximum number of bytes.  Must be <= the limit of the
       * Schema BoundedVec used for registration.
       **/
      setMaxSchemaBytes: AugmentedSubmittable<(maxSize: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
