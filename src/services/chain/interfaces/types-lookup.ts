...
declare module '@polkadot/types/lookup' {
  ...
  export interface PalletSchemasCall extends Enum {
    ...
    readonly isSetMaxSchemaBytes: boolean;
    readonly asSetMaxSchemaBytes: {
      readonly maxSize: u32;
    } & Struct;
    readonly type: 'RegisterSchema' | 'SetMaxSchemaBytes';
  }
  ...
  export interface PalletMessagesError extends Enum {
    ...
    readonly isTooLargeMessage: boolean;
    ...
    readonly type: 'TooManyMessagesInBlock' | 'TooLargeMessage' | 'InvalidPaginationRequest' | 'TypeConversionOverflow' | 'InvalidMessageSourceAccount' | 'UnAuthorizedDelegate';
  }
  ...
  export interface PalletSchemasError extends Enum {
    ...
    readonly isExceedsMaxSchemaBytes: boolean;
    readonly isInvalidSchemaMaxValue: boolean;
    readonly isLessThanMinSchemaBytes: boolean;
    ...
    readonly type: 'InvalidSchema' | 'TooManySchemas' | 'ExceedsMaxSchemaBytes' | 'InvalidSchemaMaxValue' | 'LessThanMinSchemaBytes' | 'NoSuchSchema' | 'StringConversionError' | 'DeserializationError' | 'SerializationError' | 'SchemaCountOverflow';
  }
